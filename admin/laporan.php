...
<head>
    ...
    <title>Laporan Pengaduan - Admin Panel</title>
...
<body>
            ...
            <div class="main-content">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold" style="color: var(--primary-color);">Filter Laporan Pengaduan
                        </h6>
                    </div>
                    <div class="card-body">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // --- JAVASCRIPT BARU UNTUK EKSPOR & CETAK ---
        ...
        if (cetakBtn) {
            cetakBtn.addEventListener('click', function() {
                ...
                printWindow.document.write(
                    `<style>body{padding:20px;} .card-header, .btn {display:none!important;} table{margin-top:20px;} @page{size:auto;margin:10mm;}</style>`
                    );
                printWindow.document.write('</head><body><h3>Laporan Semua Pengaduan</h3><hr>');
