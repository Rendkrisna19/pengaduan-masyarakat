...
// Keamanan: Pastikan yang login adalah RW
...
// Pastikan Rw ini terasosiasi dengan wilayah Rw
if (empty($_SESSION['user_rw_id'])) {
    die("Error: Akun Anda tidak terhubung dengan data RW manapun.");
}
...
<head>
    ...
    <title>Dashboard RW - Panel Lapor</title>
