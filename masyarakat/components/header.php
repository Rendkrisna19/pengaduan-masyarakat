<?php
// masyarakat/components/header.php (VERSI LENGKAP DAN BENAR)
...
if (!isset($_SESSION['user_id'])) {
    // Jika mencoba akses halaman masyarakat tanpa login, arahkan ke login
    header("Location: ../auth/login.php");
    exit();
}

// Cek flash message dari sesi (untuk notifikasi setelah redirect)
$flash_message = $_SESSION['flash_message'] ?? null;
if ($flash_message) {
    unset($_SESSION['flash_message']); // Hapus setelah akan ditampilkan
}
?>
<!DOCTYPE html>
<html lang="id">
